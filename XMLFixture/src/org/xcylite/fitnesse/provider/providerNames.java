...
public class providerNames {
	...
	static HashMap<Integer, String> lastNameMap = setUpLastName();
	static HashMap<Integer, String> firstNameMap = setUpFirstName();
	
	
	public providerNames() {
	
		if (firstNameMap == null) {
			 firstNameMap = setUpFirstName();
			 System.out.println(" setting up first names - constructor ");
		}
		
		if (lastNameMap == null) {
			 lastNameMap = setUpLastName();
			 System.out.println(" setting up last names - constructor ");
		}
	}
	...
	public static String getProviderFirstName() {
		...
		List<String> stringList = new ArrayList<String>(firstNameMap.values());
		int randomIndex2 = new Random().nextInt(stringList.size()); 
		firstName = stringList.get(randomIndex2);
	...
	public static String getProviderLastName() {
		...
		List<String> stringList = new ArrayList<String>(lastNameMap.values());
		int randomIndex2 = new Random().nextInt(stringList.size()); 
		lastName = stringList.get(randomIndex2);
		
		return lastName;
		
	}
	
	private static HashMap<Integer, String> setUpFirstName() {
		
		System.out.println(" setting up first names - setUpFirstName() ");
		
		HashMap<Integer, String> nameMap = new HashMap<Integer, String>();
				
		nameMap.put(1 , "Jacob"); 
		nameMap.put(2 , "Michael"); 
		nameMap.put(3 , "Joshua"); 
		nameMap.put(4 , "Matthew"); 
		nameMap.put(5 , "Daniel"); 
		nameMap.put(6 , "Christopher"); 
		nameMap.put(7 , "Andrew"); 
		nameMap.put(8 , "Ethan"); 
		nameMap.put(9 , "Joseph"); 
		nameMap.put(10 , "William"); 
		nameMap.put(11 , "Anthony"); 
		nameMap.put(12 , "David"); 
		nameMap.put(13 , "Alexander"); 
		nameMap.put(14 , "Nicholas"); 
		nameMap.put(15 , "Ryan"); 
		nameMap.put(16 , "Tyler"); 
		nameMap.put(17 , "James"); 
		nameMap.put(18 , "John"); 
		nameMap.put(19 , "Jonathan"); 
		nameMap.put(20 , "Noah"); 
		nameMap.put(21 , "Brandon"); 
		nameMap.put(22 , "Christian"); 
		nameMap.put(23 , "Dylan"); 
		nameMap.put(24 , "Samuel"); 
		nameMap.put(25 , "Benjamin"); 
		nameMap.put(26 , "Nathan"); 
		nameMap.put(27 , "Zachary"); 
		nameMap.put(28 , "Logan"); 
		nameMap.put(29 , "Justin"); 
		nameMap.put(30 , "Gabriel"); 
		nameMap.put(31 , "Jose"); 
		nameMap.put(32 , "Austin"); 
		nameMap.put(33 , "Kevin"); 
		nameMap.put(34 , "Elijah"); 
		nameMap.put(35 , "Caleb"); 
		nameMap.put(36 , "Robert"); 
		nameMap.put(37 , "Thomas"); 
		nameMap.put(38 , "Jordan"); 
		nameMap.put(39 , "Cameron"); 
		nameMap.put(40 , "Jack"); 
		nameMap.put(41 , "Hunter"); 
		nameMap.put(42 , "Jackson"); 
		nameMap.put(43 , "Angel"); 
		nameMap.put(44 , "Isaiah"); 
		nameMap.put(45 , "Evan"); 
		nameMap.put(46 , "Isaac"); 
		nameMap.put(47 , "Mason"); 
		nameMap.put(48 , "Luke"); 
		nameMap.put(49 , "Jason"); 
		nameMap.put(50 , "Gavin"); 
		nameMap.put(51 , "Jayden"); 
		nameMap.put(52 , "Aaron"); 
		nameMap.put(53 , "Connor"); 
		nameMap.put(54 , "Aiden"); 
		nameMap.put(55 , "Aidan"); 
		nameMap.put(56 , "Kyle"); 
		nameMap.put(57 , "Juan"); 
		nameMap.put(58 , "Charles"); 
		nameMap.put(59 , "Luis"); 
		nameMap.put(60 , "Adam"); 
		nameMap.put(61 , "Lucas"); 
		nameMap.put(62 , "Brian"); 
		nameMap.put(63 , "Eric"); 
		nameMap.put(64 , "Adrian"); 
		nameMap.put(65 , "Nathaniel"); 
		nameMap.put(66 , "Sean"); 
		nameMap.put(67 , "Alex"); 
		nameMap.put(68 , "Carlos"); 
		nameMap.put(69 , "Ian"); 
		nameMap.put(70 , "Bryan"); 
		nameMap.put(71 , "Owen"); 
		nameMap.put(72 , "Jesus"); 
		nameMap.put(73 , "Landon"); 
		nameMap.put(74 , "Julian"); 
		nameMap.put(75 , "Chase"); 
		nameMap.put(76 , "Cole"); 
		nameMap.put(77 , "Diego"); 
		nameMap.put(78 , "Jeremiah"); 
		nameMap.put(79 , "Steven"); 
		nameMap.put(80 , "Sebastian"); 
		nameMap.put(81 , "Xavier"); 
		nameMap.put(82 , "Timothy"); 
		nameMap.put(83 , "Carter"); 
		nameMap.put(84 , "Wyatt"); 
		nameMap.put(85 , "Brayden"); 
		nameMap.put(86 , "Blake"); 
		nameMap.put(87 , "Hayden"); 
		nameMap.put(88 , "Devin"); 
		nameMap.put(89 , "Cody"); 
		nameMap.put(90 , "Richard"); 
		nameMap.put(91 , "Seth"); 
		nameMap.put(92 , "Dominic"); 
		nameMap.put(93 , "Jaden"); 
		nameMap.put(94 , "Antonio"); 
		nameMap.put(95 , "Miguel"); 
		nameMap.put(96 , "Liam"); 
		nameMap.put(97 , "Patrick"); 
		nameMap.put(98 , "Carson"); 
		nameMap.put(99 , "Jesse"); 
		nameMap.put(100 , "Tristan");  
		nameMap.put(101 , "Emily"); 
		nameMap.put(102 , "Madison"); 
		nameMap.put(103 , "Emma"); 
		nameMap.put(104 , "Olivia"); 
		nameMap.put(105 , "Hannah"); 
		nameMap.put(106 , "Abigail"); 
		nameMap.put(107 , "Isabella"); 
		nameMap.put(108 , "Samantha"); 
		nameMap.put(109 , "Elizabeth"); 
		nameMap.put(110 , "Ashley"); 
		nameMap.put(111 , "Alexis"); 
		nameMap.put(112 , "Sarah"); 
		nameMap.put(113 , "Sophia"); 
		nameMap.put(114 , "Alyssa"); 
		nameMap.put(115 , "Grace"); 
		nameMap.put(116 , "Ava"); 
		nameMap.put(117 , "Taylor"); 
		nameMap.put(118 , "Brianna"); 
		nameMap.put(119 , "Lauren"); 
		nameMap.put(120 , "Chloe"); 
		nameMap.put(121 , "Natalie"); 
		nameMap.put(122 , "Kayla"); 
		nameMap.put(123 , "Jessica"); 
		nameMap.put(124 , "Anna"); 
		nameMap.put(125 , "Victoria"); 
		nameMap.put(126 , "Mia"); 
		nameMap.put(127 , "Hailey"); 
		nameMap.put(128 , "Sydney"); 
		nameMap.put(129 , "Jasmine"); 
		nameMap.put(130 , "Julia"); 
		nameMap.put(131 , "Morgan"); 
		nameMap.put(132 , "Destiny"); 
		nameMap.put(133 , "Rachel"); 
		nameMap.put(134 , "Ella"); 
		nameMap.put(135 , "Kaitlyn"); 
		nameMap.put(136 , "Megan"); 
		nameMap.put(137 , "Katherine"); 
		nameMap.put(138 , "Savannah"); 
		nameMap.put(139 , "Jennifer"); 
		nameMap.put(140 , "Alexandra"); 
		nameMap.put(141 , "Allison"); 
		nameMap.put(142 , "Haley"); 
		nameMap.put(143 , "Maria"); 
		nameMap.put(144 , "Kaylee"); 
		nameMap.put(145 , "Lily"); 
		nameMap.put(146 , "Makayla"); 
		nameMap.put(147 , "Brooke"); 
		nameMap.put(148 , "Mackenzie"); 
		nameMap.put(149 , "Nicole"); 
		nameMap.put(150 , "Addison"); 
		nameMap.put(151 , "Stephanie"); 
		nameMap.put(152 , "Lillian"); 
		nameMap.put(153 , "Andrea"); 
		nameMap.put(154 , "Zoe"); 
		nameMap.put(155 , "Faith"); 
		nameMap.put(156 , "Kimberly"); 
		nameMap.put(157 , "Madeline"); 
		nameMap.put(158 , "Alexa"); 
		nameMap.put(159 , "Katelyn"); 
		nameMap.put(160 , "Gabriella"); 
		nameMap.put(161 , "Gabrielle"); 
		nameMap.put(162 , "Trinity"); 
		nameMap.put(163 , "Amanda"); 
		nameMap.put(164 , "Kylie"); 
		nameMap.put(165 , "Mary"); 
		nameMap.put(166 , "Paige"); 
		nameMap.put(167 , "Riley"); 
		nameMap.put(168 , "Leah"); 
		nameMap.put(169 , "Jenna"); 
		nameMap.put(170 , "Sara"); 
		nameMap.put(171 , "Rebecca"); 
		nameMap.put(172 , "Michelle"); 
		nameMap.put(173 , "Sofia"); 
		nameMap.put(174 , "Vanessa"); 
		nameMap.put(175 , "Jordan"); 
		nameMap.put(176 , "Angelina"); 
		nameMap.put(177 , "Caroline"); 
		nameMap.put(178 , "Avery"); 
		nameMap.put(179 , "Audrey"); 
		nameMap.put(180 , "Evelyn"); 
		nameMap.put(181 , "Maya"); 
		nameMap.put(182 , "Claire"); 
		nameMap.put(183 , "Autumn"); 
		nameMap.put(184 , "Jocelyn"); 
		nameMap.put(185 , "Ariana"); 
		nameMap.put(186 , "Nevaeh"); 
		nameMap.put(187 , "Arianna"); 
		nameMap.put(188 , "Jada"); 
		nameMap.put(189 , "Bailey"); 
		nameMap.put(190 , "Brooklyn"); 
		nameMap.put(191 , "Aaliyah"); 
		nameMap.put(192 , "Amber"); 
		nameMap.put(193 , "Isabel"); 
		nameMap.put(194 , "Mariah"); 
		nameMap.put(195 , "Danielle"); 
		nameMap.put(196 , "Melanie"); 
		nameMap.put(197 , "Sierra"); 
		nameMap.put(198 , "Erin"); 
		nameMap.put(199 , "Molly"); 
		nameMap.put(200 , "Amelia"); 

		return nameMap;

	}
	
	private static HashMap<Integer, String> setUpLastName() {
		
		System.out.println(" setting up first names - setUpLastName() ");
